...
-- Add payment_method column if upgrading existing database
ALTER TABLE `roombook` ADD COLUMN IF NOT EXISTS `payment_method` varchar(50) NOT NULL DEFAULT 'Cash';
ALTER TABLE `payment` ADD COLUMN IF NOT EXISTS `payment_method` varchar(50) NOT NULL DEFAULT 'Cash';
